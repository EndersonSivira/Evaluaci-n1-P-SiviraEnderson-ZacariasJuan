...
Nombres completos de los integrantes: Sivira Enderson C.I: 31.756.617,  Zacarias Juan C.I: 31.756.691

Enunciado asignado:
Enunciado 2: Gestion de Inventario

Instrucciones breves para ejecutar el proyecto:

1-Abrir la terminal: Abre una terminal dentro de la carpeta del proyecto
